...
export function getFilterableWithIndex() {
    return __assign(__assign({}, readonlyMap), { _E: undefined, mapWithIndex: mapWithIndex_, partitionMapWithIndex: partitionMapWithIndex_, partitionWithIndex: partitionWithIndex_, filterMapWithIndex: filterMapWithIndex_, filterWithIndex: filterWithIndex_ });
}
/**
 * @since 2.5.0
 */
